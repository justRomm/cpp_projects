/* БС-14 Романюк М.Д.
 * Розробка програмного забезпечення з використанням об’єктно-орієнтованого підходу.*/

#define _CRT_SECURE_NO_WARNINGS
#include "QueueP.h"
// -------------------------------------------------------------------------------------------------
// Функція меню користувача
void Run()
{
	// Створення об'єкту типу черги з пріоритетом
